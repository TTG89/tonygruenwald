...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  const getIconForFeature = (iconName: string) => {
    const iconMap: { [key: string]: React.JSX.Element } = {
      ...
      recipe: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={1.5}
            d="M7 4V2a1 1 0 011-1h4a1 1 0 011 1v2M7 4h10l1 12H6L7 4z"
          />
        </svg>
      ),
      sparkle: (
      ...
      // New icons for Saltwater Getaway project
      squarespace: (
        <svg
          className="h-6 w-6 text-gray-900"
          fill="none"
      ...
      // New icons for OceanBlue Omega project
      quiz: (
        <svg
          className="h-6 w-6 text-gray-900"
          fill="none"
      ...
      // New icons for Carbon Marine project
      marine: (
        <svg
          className="h-6 w-6 text-gray-900"
          fill="none"
      ...
      specifications: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={1.5}
            d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 4h6m-6 4h6m-3-8v8"
          />
        </svg>
      ),
      guide: (
